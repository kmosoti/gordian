...
changes ([`issue-index.md`](issue-index.md#adding-or-splitting-an-atom)).
`gordian-atom-registry render-plan --write` regenerates existing rows, while
`gordian-atom-registry check` fails on a missing/extra row, Initiative mismatch, stale title, or
stale blocker cell. These commands implement the derived-register portion of **G-413 and G-445,
assigned to #70**.
...
```text
unresolved_human_metric: #50 — operator-comprehension rating — the ontology ablation scores how quickly a person understands a Mission's decomposition; no machine proxy measures comprehension, and substituting one would answer a different question than the hypothesis asks.
unresolved_human_metric: #54 — operator/manual correction count — counts corrections a human chose to make against a mutable-status baseline; the count is defined by human intervention, so it cannot be synthesized.
```

A waiver names one human metric; it never waives its Atom or acceptance row. #50 and #54 still need
fully validating closure records for every machine-measurable part of their contracts. Every waiver
here MUST be reproduced verbatim as an item in #69's `known_limitations`, so a qualification that
skipped human judgement can never be mistaken for one that obtained it. Waiving a metric a machine
...
| #2 | [Foundation] Stabilize Rust, formal, Python, and CI foundations | — | — |
| #3 | [Foundation] Build deterministic benchmark and workload generators | — | #2 |
| #4 | [Foundation] Establish simple reference algorithm baselines | `gordian-core` | #2, #3 |
| #5 | [Foundation] Establish performance benchmark and regression gates | — | #3, #4 |
| #6 | [Foundation] Qualify the verification technique stack | — | #2, #4 |
| #7 | [Foundation] Build Lean and Rust differential conformance testing | `gordian-core` | #2, #4, #6 |
| #8 | [Foundation] Complete research-graph coverage and epistemic audit | `gordian-kg` | #2 |
| #50 | [Experiment] Run Mission Graph ontology ablation | — | #9, #10, #13, #37, #38, #75 |
| #51 | [Experiment] Run Atom and Quark scheduling-granularity ablation | — | #10, #20, #24, #37, #38, #75 |
| #52 | [Experiment] Benchmark semantic conflict prediction against path and module baselines | — | #22, #32, #37, #75 |
| #53 | [Experiment] Compare stable snapshot execution with continuous active rebasing | — | #30, #32, #37, #38, #75 |
| #54 | [Experiment] Compare derived state with mutable workflow status | `gordian-core` | #13, #26, #37, #75 |
| #59 | [Experiment] Measure stale-evidence prevention and invalidation cost | — | #3, #15, #16, #31, #32, #37, #75 |
| #60 | [Experiment] Measure formal-method defect yield and maintenance cost | — | #6, #7, #10, #13, #15, #18, #19, #23, #27, #75 |
| #61 | [Experiment] Benchmark and qualify the knowledge-graph storage/query architecture | — | #3, #5, #8, #73, #75 |
...
| #73 | [Knowledge] Implement epistemic traversal, contradiction, and downstream-impact queries | `gordian-kg` | #71, #72 |
...
| #10 | [Mission Graph Kernel] Implement decomposition and hard-dependency validation | `gordian-core` | #4, #5, #7, #9, #58 |
| #11 | [Mission Graph Kernel] Implement ExecutionAttempt, Candidate, and effect semantics | `gordian-core` | #9 |
| #12 | [Mission Graph Kernel] Implement canonical events and deterministic projection | `gordian-core` | #4, #7, #9, #11 |
| #13 | [Mission Graph Kernel] Implement acceptance predicates and derived work state | `gordian-core` | #7, #10, #11, #12, #15 |
...
| #57 | [Planning & Reconciliation] Implement desired-versus-observed reconciliation and repair planning | `gordian-coordination` | #12, #13, #15, #26, #55, #56 |

# Initiative: Evidence, Provenance, and Authority

| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #14 | [Evidence & Authority] Implement content-addressed artifact storage | `gordian-artifacts` | #2, #4, #5 |
...
| #18 | [Evidence & Authority] Implement capability policy and evaluate Cedar | `gordian-coordination` | #6, #7, #9 |
| #19 | [Evidence & Authority] Implement candidate admission and accepted-frontier CAS | `gordian-coordination` | #7, #13, #15, #16, #17, #18 |

# Initiative: Scheduling and Coordination

| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #20 | [Scheduling & Coordination] Implement dependency-aware ready queue and critical-path analysis | `gordian-scheduler` | #3, #4, #7, #10, #13 |
| #21 | [Scheduling & Coordination] Implement worker capability and resource compatibility | `gordian-scheduler` | #18, #20 |
| #22 | [Scheduling & Coordination] Implement semantic resource claims and scope observation | `gordian-scheduler` | #7, #9, #11, #12 |
| #23 | [Scheduling & Coordination] Implement lease and fencing arbitration | `gordian-coordination` | #7, #18, #22 |
...
| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #25 | [Persistence & Replay] Implement PostgreSQL canonical persistence | `gordian-postgres` | #9, #10, #11, #12, #15, #18, #23 |
| #26 | [Persistence & Replay] Implement materialized projections and deterministic rebuild | `gordian-postgres` | #12, #13, #19, #20, #25 |
| #27 | [Persistence & Replay] Implement transactional frontier, lease, and plan-selection transitions | `gordian-postgres` | #19, #23, #25 |
| #28 | [Persistence & Replay] Build crash, duplicate-event, and recovery fault suite | `gordian-postgres` | #26, #27 |

# Initiative: Jujutsu Change Plane

| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #29 | [Jujutsu Change Plane] Define the source-adapter trait and implement the Jujutsu adapter | `gordian-source` (trait), `gordian-jj` | #1, #2 |
...
| #34 | [Jujutsu Change Plane] Run the Jujutsu versus Git source-substrate experiment | `gordian-source` | #3, #5, #29, #30, #31, #32, #33, #38, #75, #76 |
| #76 | [Jujutsu Change Plane] Implement Git worktree source adapter behind the source-adapter trait | `gordian-git` | #29, #30, #31, #32, #33 |
...
| #36 | [Agent Execution] Implement generic process and agent worker adapter | `gordian-runtime` | #30, #31, #35 |
| #37 | [Agent Execution] Implement thin Python subprocess runner, seed matrix, and raw artifact capture (foundation subset) | `gordian-experiments` | #2, #3, #75 |
| #38 | [Agent Execution] Implement local multi-worker coordinator | `gordian-runtime` | #24, #27, #32, #33, #36 |
| #39 | [Agent Execution] Run isolation and coordination ablation | — | #3, #37, #38, #75, #77 |
| #62 | [Agent Execution] Implement and qualify sandbox backends for untrusted workers | `gordian-runtime` | #6, #18, #35, #36 |
| #63 | [Agent Execution] Implement capability-scoped secret and credential brokerage | `gordian-runtime` | #18, #35, #58, #62 |
| #77 | [Agent Execution] Launch and supervise experiment workers | `gordian-runtime` | #2, #5, #35, #36, #37 |

# Initiative: Distributed Robustness

| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #40 | [Distributed Robustness] Define remote worker transport and idempotent command protocol | `gordian-runtime` | #12, #27, #35, #38 |
| #41 | [Distributed Robustness] Implement distributed lease and accepted-frontier coordination | `gordian-runtime` | #23, #27, #40 |
| #42 | [Distributed Robustness] Build deterministic distributed fault simulation | `gordian-runtime` | #40, #41 |
| #43 | [Distributed Robustness] Instrument Gordian with OpenTelemetry-compatible observability | `gordian-runtime` | #38 |

# Initiative: Human and Programmatic Interface

| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #44 | [Interfaces] Implement the Gordian CLI | `gordian-runtime` | #19, #20, #25, #26, #32, #33 |
| #45 | [Interfaces] Implement a headless typed API and event stream | `gordian-runtime` | #18, #25, #27, #44 |
| #46 | [Interfaces] Implement GitHub bootstrap and import adapter | `gordian-runtime` | #25, #45, #58 |
| #47 | [Interfaces] Build Mission Graph and evidence explorer | — | #22, #32, #45, #64 |
...
| Atom | Title | Target crate | Blocked by |
| --- | --- | --- | --- |
| #64 | [Release & Deployment] Implement immutable release and deployment records | `gordian-core` (domain records), `gordian-coordination` | #17, #19, #25, #27, #58 |
| #65 | [Release & Deployment] Build reproducible signed distribution artifacts | — | #2, #14, #17, #44, #45, #64 |
| #66 | [Release & Deployment] Implement backup, restore, migration, and compatibility qualification | `gordian-postgres` | #14, #25, #26, #64, #65 |
| #67 | [Release & Deployment] Perform adversarial security and authority qualification | `gordian-runtime` | #18, #19, #23, #27, #35, #40, #62, #63, #65 |
...
| #69 | [Self-Hosting] Produce the end-to-end release qualification evidence bundle | — | #28, #42, #43, #47, #49, #57, #65, #66, #67, #68 |
