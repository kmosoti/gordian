# Integration Non-Compositionality Suite

Graph node: `experiment:integration-composition`
Intended class: `fault-injection` (see [`../../docs/testing/statistical-contract.md`](../../docs/testing/statistical-contract.md) section 2)
Owning issue: #32

Construct candidate pairs that pass independently and fail after composition, covering API contract, schema, config, resource, and test-only interactions with no textual merge conflict.
