# Scheduler Baseline and Optimization Benchmark

Graph node: `experiment:scheduler-benchmarks`
Intended class: `benchmark` (see [`../../docs/testing/statistical-contract.md`](../../docs/testing/statistical-contract.md) section 2)
Owning issue: #24

Compare FIFO/greedy ready-queue scheduling, critical-path priority, and HEFT-inspired heterogeneous scheduling on synthetic and repository-derived DAGs under heterogeneous worker costs and capabilities.
